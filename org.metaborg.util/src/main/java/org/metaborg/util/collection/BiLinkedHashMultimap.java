...
/**
 * Bidirectional multimap that cannot hold duplicate key value pairs. Uses {@link LinkedHashMultimap} as
 * backing multimaps.
 */
public class BiLinkedHashMultimap<K, V> implements BiSetMultimap<K, V> {
    ...
    @Override public Set<K> removeAllInverse(Object value) {
    ...
    @Override public SetMultimap<K, V> keyToValue() {
        return keyToValue;
    }

    @Override public SetMultimap<V, K> valueToKey() {
        return valueToKey;
    }
}