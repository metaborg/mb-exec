...
/**
 * <p>This is a utility class used by selectors, adapted
 * from Apache Ant.
 * </p>
 */
public final class AntPattern {
    ...
    public boolean match(String path) {
        return matchPath(tokenizedPattern,
                tokenizePathAsArray(path),
     ...
     */
    private static boolean matchPath(String[] tokenizedPattern, String[] strDirs,
    ...
    /**
     * Breaks a path up into an array of path elements, tokenizing on
