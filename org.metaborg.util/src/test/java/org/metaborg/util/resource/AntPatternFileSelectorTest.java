...
public class AntPatternFileSelectorTest {
    ...
    @Test
    public void testOneLevel() throws FileSystemException {
    ...
    @Test
    public void testRecursive() throws FileSystemException {
        final FileSelector selector = new AntPatternFileSelector("**");
        final FileObject[] files = baseFolder.findFiles(selector);
    ...
    @Test
    public void testFolder() throws FileSystemException {
    ...
    @Test
    public void testInFolder() throws FileSystemException {
        final FileSelector selector = new AntPatternFileSelector("dir1/*");
        final FileObject[] files = baseFolder.findFiles(selector);
        assertEquals(2, files.length);
    }
    ...
    @Test
    public void testInFolderRecursive() throws FileSystemException {
        final FileSelector selector = new AntPatternFileSelector("dir1/**");
        final FileObject[] files = baseFolder.findFiles(selector);
    ...
    @Test
    public void testImplicitlyInFolder() throws FileSystemException {
        final FileSelector selector = new AntPatternFileSelector("dir1/");
        final FileObject[] files = baseFolder.findFiles(selector);
        assertEquals(4, files.length);
    }
    ...
    @Test
    public void testQuestionMark() throws FileSystemException {
