...
public class Generic_Typedid extends AbstractNode implements I_Typedid, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Typedid (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      if(name.equals("VarDec") && term.getSubtermCount() == 2)
      { 
        I_Node replacement = replace(new VarDec_2(source, Tools.asJavaString(term.getSubterm(0)), new Generic_Type(source, term.getSubterm(1))));
        if(depth > 0)
        { 
