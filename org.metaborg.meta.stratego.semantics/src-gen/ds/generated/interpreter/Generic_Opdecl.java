...
public class Generic_Opdecl extends AbstractNode implements I_Opdecl, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Opdecl (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      { 
        I_Node replacement = replace(new ExtOpDeclInj_1(source, new Generic_Type(source, term.getSubterm(0))));
        if(depth > 0)
        { 
      ...
      { 
        ...
        { 
          I_Node replacement = replace(new ExtOpDeclQ_2(source, Tools.asJavaString(term.getSubterm(0)), new Generic_Type(source, term.getSubterm(1))));
          if(depth > 0)
          { 
            replacement.specializeChildren(depth - 1);
          }
        ...
        { 
          ...
          { 
            I_Node replacement = replace(new ExtOpDecl_2(source, Tools.asJavaString(term.getSubterm(0)), new Generic_Type(source, term.getSubterm(1))));
            if(depth > 0)
            { 
              replacement.specializeChildren(depth - 1);
            }
          ...
          { 
            ...
            { 
              I_Node replacement = replace(new OpDeclInj_1(source, new Generic_Type(source, term.getSubterm(0))));
              if(depth > 0)
              { 
                replacement.specializeChildren(depth - 1);
              }
            ...
            { 
              ...
              { 
                I_Node replacement = replace(new OpDeclQ_2(source, Tools.asJavaString(term.getSubterm(0)), new Generic_Type(source, term.getSubterm(1))));
                if(depth > 0)
                { 
                  replacement.specializeChildren(depth - 1);
                }
              ...
              { 
                ...
                { 
                  I_Node replacement = replace(new OpDecl_2(source, Tools.asJavaString(term.getSubterm(0)), new Generic_Type(source, term.getSubterm(1))));
                  if(depth > 0)
                  { 
                    replacement.specializeChildren(depth - 1);
                  }
