...
public class Generic_Wld extends AbstractNode implements I_Wld, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Wld (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      { 
        I_Node replacement = replace(new Wld_0(source));
        if(depth > 0)
        { 
