...
public class Generic_I_Sdecl extends AbstractNode implements I_Sdecl,
		IGenericNode {
	public IStrategoTerm aterm;

	public Generic_I_Sdecl(INodeSource source, IStrategoTerm term) {
	...
	@Override
	public I_Sdecl specialize(int depth) {
