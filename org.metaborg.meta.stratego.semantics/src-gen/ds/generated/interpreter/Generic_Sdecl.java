...
public class Generic_Sdecl extends AbstractNode implements I_Sdecl, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Sdecl (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      if(name.equals("Constructors") && term.getSubtermCount() == 1)
      { 
        I_Node replacement = replace(new Constructors_1(source, (INodeList)NodeUtils.makeList(term.getSubterm(0).getSubtermCount(), term.getSubterm(0), Generic_Opdecl.class)));
        if(depth > 0)
        { 
