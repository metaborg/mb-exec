...
public class Generic_Module extends AbstractNode implements I_Module, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Module (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      { 
        I_Node replacement = replace(new Specification_1(source, (INodeList)NodeUtils.makeList(term.getSubterm(0).getSubtermCount(), term.getSubterm(0), Generic_Decl.class)));
        if(depth > 0)
        { 
