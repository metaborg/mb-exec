...
public class Generic_I_Typedid extends AbstractNode implements I_Typedid,
		IGenericNode {
	public IStrategoTerm aterm;

	public Generic_I_Typedid(INodeSource source, IStrategoTerm term) {
	...
	@Override
	public I_Typedid specialize(int depth) {
		if (aterm instanceof IStrategoAppl) {
			...
			if (name.equals("VarDec") && term.getSubtermCount() == 2) {
				I_Typedid replacement = replace(new VarDec_2(source,
