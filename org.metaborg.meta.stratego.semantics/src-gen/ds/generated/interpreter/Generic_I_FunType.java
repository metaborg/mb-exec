...
public class Generic_I_FunType extends AbstractNode implements I_FunType,
		IGenericNode {
	public IStrategoTerm aterm;

	public Generic_I_FunType(INodeSource source, IStrategoTerm term) {
	...
	@Override
	public I_FunType specialize(int depth) {
		if (aterm instanceof IStrategoAppl) {
			...
			if (name.equals("FunType") && term.getSubtermCount() == 2) {
				I_FunType replacement = replace(new FunType_2(source,
						(INodeList) NodeUtils.makeList(term.getSubterm(0)
								.getSubtermCount(), term.getSubterm(0),
								Generic_I_Type.class), new Generic_I_Type(
