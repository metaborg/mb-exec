...
public class Seq_2 extends NoOpNode implements I_Strategy
{ 
  ...
  { 
    ...
    final default_Result tmpresult18 = s1.exec_default(senv_1, venv_1, ic_1, tf_1, t_1, trace_1, sheap_1, bool_1, vheap_1);
    final AValue v1 = tmpresult18.value;
    final org.spoofax.interpreter.core.StackTracer trace_2 = tmpresult18.get_1();
    final ds.manual.interpreter.SState sheap_2 = tmpresult18.get_2();
    final boolean bool_2 = tmpresult18.get_3();
    final ds.manual.interpreter.VState vheap_2 = tmpresult18.get_4();
    final S_1 tmpbuild107 = v1.match(S_1.class);
    if(tmpbuild107 != null)
    { 
      final org.spoofax.interpreter.terms.IStrategoTerm t_ = tmpbuild107.get_1();
      final default_Result tmpresult17 = s2.exec_default(senv_1, venv_1, ic_1, tf_1, t_, trace_2, sheap_2, bool_2, vheap_2);
      final AValue v2 = tmpresult17.value;
      final org.spoofax.interpreter.core.StackTracer trace_3 = tmpresult17.get_1();
      final ds.manual.interpreter.SState sheap_3 = tmpresult17.get_2();
      final boolean bool_3 = tmpresult17.get_3();
      final ds.manual.interpreter.VState vheap_3 = tmpresult17.get_4();
      ...
      final default_Result default_Result6 = new default_Result(lifted_out_1, lifted_out_2, lifted_out_3, lifted_out_4, lifted_out_5);
      return default_Result6;
    }
    else
    { 
      final F_0 tmpbuild108 = v1.match(F_0.class);
      if(tmpbuild108 != null)
      { 
