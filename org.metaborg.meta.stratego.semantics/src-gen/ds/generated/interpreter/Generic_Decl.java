...
public class Generic_Decl extends AbstractNode implements I_Decl, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Decl (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      { 
        I_Node replacement = replace(new Signature_1(source, (INodeList)NodeUtils.makeList(term.getSubterm(0).getSubtermCount(), term.getSubterm(0), Generic_Sdecl.class)));
        if(depth > 0)
        { 
      ...
      { 
        ...
        { 
          I_Node replacement = replace(new Strategies_1(source, (INodeList)NodeUtils.makeList(term.getSubterm(0).getSubtermCount(), term.getSubterm(0), Generic_Def.class)));
          if(depth > 0)
          { 
            replacement.specializeChildren(depth - 1);
          }
