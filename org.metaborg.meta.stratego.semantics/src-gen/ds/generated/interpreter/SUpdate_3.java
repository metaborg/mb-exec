...
public class SUpdate_3 extends NoOpNode implements I_SHeapOp
{ 
  ...
  public SUpdate_3 (INodeSource source, com.github.krukow.clj_ds.PersistentMap<Object, Object> _1, String _2, I_Thunk _3) 
  { 
  ...
  { 
    ...
    final com.github.krukow.clj_ds.PersistentMap<Object, Object> tmpbuild562 = s.update(senv, name, thunk);
    final com.github.krukow.clj_ds.PersistentMap<Object, Object> senv_ = tmpbuild562;
    ...
    final salloc_Result salloc_Result2 = new salloc_Result(lifted_out_1, lifted_out_2);
    return salloc_Result2;
  }
