...
public class Generic_Anno extends AbstractNode implements I_Anno, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Anno (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      { 
        I_Node replacement = replace(new Internal_0(source));
        if(depth > 0)
        { 
      ...
      { 
        ...
        { 
          I_Node replacement = replace(new Override_0(source));
          if(depth > 0)
          { 
            replacement.specializeChildren(depth - 1);
          }
        ...
        { 
          ...
          { 
            I_Node replacement = replace(new Extend_0(source));
            if(depth > 0)
            { 
              replacement.specializeChildren(depth - 1);
            }
