...
public class Generic_SVar extends AbstractNode implements I_SVar, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_SVar (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      { 
        I_Node replacement = replace(new SVar_1(source, Tools.asJavaString(term.getSubterm(0))));
        if(depth > 0)
        { 
