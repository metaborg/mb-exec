...
public class Generic_ConstType extends AbstractNode implements I_ConstType, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_ConstType (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      if(name.equals("ConstType") && term.getSubtermCount() == 1)
      { 
        I_Node replacement = replace(new ConstType_1(source, new Generic_Sort(source, term.getSubterm(0))));
        if(depth > 0)
        { 
