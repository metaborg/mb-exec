...
public class Generic_Var extends AbstractNode implements I_Var, IGenericNode
{ 
  public IStrategoTerm aterm;

  public Generic_Var (INodeSource source, IStrategoTerm term) 
  { 
  ...
  { 
    ...
    { 
      ...
      { 
        I_Node replacement = replace(new Var_1(source, Tools.asJavaString(term.getSubterm(0))));
        if(depth > 0)
        { 
