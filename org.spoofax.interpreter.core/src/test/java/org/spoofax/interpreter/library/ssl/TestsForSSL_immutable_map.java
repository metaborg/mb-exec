...
public class TestsForSSL_immutable_map extends ImmutableSetMapTestSetup {
    ...
    @Test
    public void mapFilterKeysUnique() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_filter.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // filter on key == one
    ...
    @Test
    public void mapFilterKeysNonUnique() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_filter.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // map key in pair to one
            env.setCurrent(f.makeTuple(one, env.current().getSubterm(1)));
            return hooks.pop().onSuccess(env);
        }), TestStrategy.of((env, hooks) -> {
    ...
    @Test
    public void mapFilterKeysFailMerge() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_filter.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // map key in pair to one
            env.setCurrent(f.makeTuple(one, env.current().getSubterm(1)));
    ...
    @Test
    public void mapGetNonExisting() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    public void mapGetExistingCustomEq() throws InterpreterException {
        ...
        boolean result = SSL_immutable_map_get_eq.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
    ...
    @Test
    public void mapIntersectEmpty() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapIntersectMerge() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_intersect.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // map pair to first
    ...
    @Test
    public void mapIntersectMergeFail() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_intersect.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            return hooks.pop().onFailure(env);
        }) }, new IStrategoTerm[] { new StrategoImmutableMap(Map.Immutable.of(one, b)) });
    ...
    @Test
    public void mapIntersectSet() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapMapFail() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_map.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // filter on key == one
            if(env.current().getSubterm(0).equals(one)) {
                return hooks.pop().onSuccess(env);
            } else {
    ...
    @Test
    public void mapMapKeysNonUnique() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_map.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // map key in pair to one
            env.setCurrent(f.makeTuple(one, env.current().getSubterm(1)));
    ...
    @Test
    public void mapMapKeysFailMerge() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_map.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // map key in pair to one
            env.setCurrent(f.makeTuple(one, env.current().getSubterm(1)));
    ...
    @Test
    public void mapPutNonExisting() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapPutExisting() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapRemoveExisting() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapRemoveNonExisting() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapSubtractEmpty() throws InterpreterException {
    ...
    @Test
    public void mapSubtractOverlappingKeys() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_subtract
    ...
    @Test
    public void mapSubtractNonOverlappingKeys() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapSubtractSet() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
    ...
    @Test
    public void mapUnionEmpty() throws InterpreterException {
        StrategoImmutableMap before = new StrategoImmutableMap(Map.Immutable.of(one, a, two, b));
        context.setCurrent(before);
    ...
    @Test
    public void mapUnionOverlappingKeys() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
        boolean result = SSL_immutable_map_union.call(context, new Strategy[] { TestStrategy.of((env, hooks) -> {
            // map pair to first
            env.setCurrent(env.current().getSubterm(0));
            return hooks.pop().onSuccess(env);
        }) }, new IStrategoTerm[] { new StrategoImmutableMap(Map.Immutable.of(one, b)) });
    ...
    @Test
    public void mapUnionNonOverlappingKeys() throws InterpreterException {
        context.setCurrent(new StrategoImmutableMap(Map.Immutable.of(one, a, two, b)));
