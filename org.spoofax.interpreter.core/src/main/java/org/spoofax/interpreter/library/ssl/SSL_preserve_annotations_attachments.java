 ...
 */
public class SSL_preserve_annotations_attachments extends AbstractPrimitive {

	public SSL_preserve_annotations_attachments() {
		super("SSL_preserve_annotations_attachments", 1, 0);
	}
