 ...
 *
 * Copyright (c) 2005-2009, Karl Trygve Kalleberg <karltk near strategoxt.org>
 * 
 * Licensed under the GNU General Public License, v2
 */
package org.spoofax.interpreter.terms;

public class BasicStrategoArrayList extends BasicStrategoTerm implements IStrategoList {

    protected final IStrategoTerm[] kids;
    
    protected BasicStrategoArrayList(IStrategoTerm[] kids, IStrategoList annos) {
        super(annos);
        this.kids = kids;
    }
    ...
    public IStrategoList tail() {
        return new BasicStrategoArrayList(doTail());
    }
    ...
    public IStrategoList prepend(IStrategoTerm prefix) {
        return new BasicStrategoArrayList(doPrepend(prefix));
    }
